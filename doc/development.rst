...
* for Windows: use an online tool (e.g. `png2ico <https://www.png2ico.com/>`__) to convert a 256x256 PNG file to an ICO file (use default options)
...
* Install the ``smctl`` tool: `Official Guide <https://docs.digicert.com/en/software-trust-manager/client-tools/command-line-interface/smctl.html#download-smctl-487706>`__
* Set your PATH environment variable correctly: `Official Guide <https://docs.digicert.com/zf/software-trust-manager/code-signing/sign-with-digicert-signing-tools/sign-binaries-with-smctl.html#-en--set-path-environment-variables-401417>`__
...
* Check that SignTool is linked correctly: ``smctl healthcheck --tools`` / ``signtool`` (`Guide to set PATH environment variable <https://docs.digicert.com/zf/software-trust-manager/code-signing/sign-with-digicert-signing-tools/sign-binaries-with-smctl.html#-en--set-path-environment-variables-401417>`__)
* Microsoft SignTool
